...
st.set_page_config(page_title="cf-mtDNA Prognostic Score Calculator", layout="centered")
st.title("cf-mtDNA-based Prognostic Score for HBV-ACLF")

st.markdown("""
This tool calculates the **cf-mtDNA-based prognostic score** for predicting 28- and 90-day mortality in HBV-related ACLF patients.
